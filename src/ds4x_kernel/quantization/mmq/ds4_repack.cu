 ...
 * ds4_mmq_q8_0_aligned_dense_vec (quantization/mmq/ds4_mmq.h). ADDITIVE: the raw
 ...
 * ds4_mmq_iq2_xxs_aligned_moe_vec (quantization/mmq/ds4_mmq.h). These REPLACE the
 ...
 * (quantization/mmq/ds4_mmq.h). Chunks are whole row pairs so the repack kernel's
