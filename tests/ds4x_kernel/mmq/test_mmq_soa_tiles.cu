...
// switch).
//
// Build on DGX Spark after `make -j6 kernel-test` built the MMQ objects:
//   ar rcs libds4mmq.a build/obj/ds4x_kernel/quantization/mmq/*.o
//   /usr/local/cuda/bin/nvcc -O3 --use_fast_math -std=c++17 -arch=sm_121 \
//        -Isrc/ds4x_kernel/quantization/mmq \
//        tests/ds4x_kernel/mmq/test_mmq_soa_tiles.cu libds4mmq.a \
...
// libds4mmq.a references this backend symbol from the q8-fold vec paths
