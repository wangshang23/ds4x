...
| Test                                          | Status                       | Phase     |
|-----------------------------------------------|------------------------------|-----------|
| `nvcc -c src/cuda/mmq/ds4_mmq.cu` builds cleanly | **passes** (sm_120, nvcc 13) | Phase 0 |
...
probes for the adapted kernels live in `src/cuda/mmq/test/`.
